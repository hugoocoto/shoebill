...
M.style = function()
        ...
        highlight(0, "BlinkCmpDocCursorLine", { bg = light_black, fg = fg })
        highlight(0, "BlinkCmpKind", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindClass", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindColor", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindConstant", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindConstructor", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindEnum", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindEnumMember", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindEvent", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindField", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindFile", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindFolder", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindFunction", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindInterface", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindKeyword", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindMethod", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindModule", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindOperator", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindProperty", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindReference", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindSnippet", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindStruct", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindText", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindTypeParameter", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindUnit", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindValue", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpKindVariable", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpLabel", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpLabelMatch", { bg = dark_black, fg = fg })
        highlight(0, "BlinkCmpMenu", { bg = light_black, fg = fg })
