...
M.style           = function(mode)
        ...
        highlight(0, "@lsp.typemod.variable.static", { link = "@variable" })
        ...
        highlight(0, "BlinkCmpKindConstructor", {})
        highlight(0, "BlinkCmpKindEnum", {})
        highlight(0, "BlinkCmpKindEnumMember", {})
        highlight(0, "BlinkCmpKindEvent", {})
        highlight(0, "BlinkCmpKindField", {})
        highlight(0, "BlinkCmpKindFile", {})
        highlight(0, "BlinkCmpKindFolder", {})
        highlight(0, "BlinkCmpKindFunction", {})
        highlight(0, "BlinkCmpKindInterface", {})
        highlight(0, "BlinkCmpKindKeyword", {})
        highlight(0, "BlinkCmpKindMethod", {})
        highlight(0, "BlinkCmpKindModule", {})
        highlight(0, "BlinkCmpKindOperator", {})
        highlight(0, "BlinkCmpKindProperty", {})
        highlight(0, "BlinkCmpKindReference", {})
        highlight(0, "BlinkCmpKindSnippet", {})
        highlight(0, "BlinkCmpKindStruct", {})
        highlight(0, "BlinkCmpKindText", {})
        highlight(0, "BlinkCmpKindTypeParameter", {})
        highlight(0, "BlinkCmpKindUnit", {})
        ...
        highlight(0, "LazyDimmed", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyH1", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyProgressDone", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyProgressTodo", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyReasonCmd", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyReasonFt", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyReasonPlugin", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyReasonRuntime", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyReasonSource", { bg = p.bg, fg = p.fg })
        highlight(0, "LazySpecial", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyButton", { bg = p.bg, fg = p.fg })
        highlight(0, "LazyButtonActive", { bg = p.bg, fg = p.yellow })
        highlight(0, "LazyNormal", { bg = p.bg, fg = p.fg })
        ...
        highlight(0, "MiniPickHeader", { link = "MiniPickNormal" })
        ...
        highlight(0, "MiniPickPreviewLine", { link = "MiniPickNormal" })
        highlight(0, "MiniPickPreviewRegion", { link = "MiniPickNormal" })
        ...
        -- highlight(0, "NoiceCmdlinePopBorderSearch", { link = "CustomPickleBlue" })
        ...
        highlight(0, "TelescopeMultiIcon", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopeSelection", { bg = p.dark_black })
        highlight(0, "TelescopeMultiSelection", { link = "TelescopeSelection" })
        highlight(0, "TelescopeNormal", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewDate", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewGroup", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewLink", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewMatch", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewRead", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewSize", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePreviewUser", { fg = p.fg, bg = p.bg })
        highlight(0, "TelescopePromptPrefix", { fg = p.fg, bg = p.bg })
        ...
        highlight(0, "TelescopeResultsSpecialComment", { fg = p.fg, bg = p.bg })
